...
export function DeliveryTrainDialog({
  ...
  const select = (trainNumber: string, trainName: string) => {
    ...
    toast.success(`Delivery train set to #${trainNumber} — ${trainName}`);
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Search for your train to change where we deliver — or enter the number directly.
          </DialogDescription>
        </DialogHeader>
        ...
        {searchError && (
          <p className="text-xs text-destructive">
            {searchError} — enter your train number manually below.
          </p>
        )}
